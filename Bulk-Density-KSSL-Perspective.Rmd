...
## Soil bulk density is fundamental to interpretation of laboratory data.
...
$$Cp = \sum_{i=1}^{n}\left(\frac{C_i}{100} * D_{b, i} * L_{i} * \left(1 - \frac{V_{fragments, i}}{V_{Whole~Soil, i}}\right)\right)$$
